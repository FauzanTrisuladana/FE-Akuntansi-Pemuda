...
interface AkunKeuanganTransactionsDialogProps {
  open: boolean;
...
export function AkunKeuanganTransactionsDialog({
  open,
  onOpenChange,
  namaAkun,
  kas,
  transactions,
  finalSaldoDisplay,
}: AkunKeuanganTransactionsDialogProps) {
  const handlePrint = () => {
    try {
      ...
      const html = `
        <html>
          <head>
            <meta charset="utf-8" />
            <title>Transaksi ${namaAkun ?? "Akun Keuangan"}</title>
            <style>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th>Deskripsi</th>
                    <th class="col-num right">Pemasukan</th>
                    <th class="col-num right">Pengeluaran</th>
