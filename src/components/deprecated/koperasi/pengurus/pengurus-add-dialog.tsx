...
export function PengurusAddDialog({
  open,
  onOpenChange,
  anggotaOptions,
  jabatanOptions,
  ...
  const selectedAnggota = anggotaOptions.find(
    (item) => String(item.id) === anggotaId,
  );
      ...
      <DialogContent className="sm:max-w-[520px]">
        <DialogForm onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Silakan masukkan data pengurus koperasi
            </DialogDescription>
          </DialogHeader>
