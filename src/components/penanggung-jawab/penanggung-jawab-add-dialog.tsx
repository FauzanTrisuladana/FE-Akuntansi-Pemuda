...
import type { PenanggungJawabFormErrors } from "./types";
...
// ─── Component ────────────────────────────────────────────────────────────────
export function PenanggungJawabAddDialog({
  open,
  onOpenChange,
  onCreate,
  errors: _errors,
}: PenanggungJawabAddDialogProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      toast.error("Gagal membuat penanggung jawab baru");
    } finally {
      setIsLoading(false);
    }
  };
